...
def transform_dataset(
    ...
    if X_num is not None and transformations.normalization is not None and dataset.X_num['train'].size != 0: #Liancheng
    ...
    if dataset.X_num['train'].size == 0 and dataset.X_num['test'].size == 0: #Liancheng
        X_num = None
    
    if dataset.X_cat is None or dataset.X_cat['train'].size == 0: #Liancheng
